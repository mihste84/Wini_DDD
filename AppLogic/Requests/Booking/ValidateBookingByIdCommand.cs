...
: IRequest<OneOf<Result<BookingValidationResultModel>, NotFound, ForbiddenResult, Unknown>>
{
    ...
    : IRequestHandler<ValidateBookingByIdCommand, OneOf<Result<BookingValidationResultModel>, NotFound, ForbiddenResult, Unknown>>
    {
        public async Task<OneOf<Result<BookingValidationResultModel>, NotFound, ForbiddenResult, Unknown>> Handle(
